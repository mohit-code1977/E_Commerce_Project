...
.badge.placed { background: rgba(34,197,94,0.15); color: #22c55e; }
.badge.shipped { background: rgba(56,189,248,0.15); color: #38bdf8; }
.badge.delivered { background: rgba(45,212,191,0.15); color: #2dd4bf; }
...
.item p { margin: 0; font-size: 13px; color: #9ca3af; }
